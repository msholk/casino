 ...
 */
contract RandomNumberConsumerV2 {
    ...
    function rawFulfillRandomWords(
        ...
        console.log("rawFulfillRandomWords");
        if (msg.sender != vrfInfo.vrfCoordinatorAddress) {
            revert OnlyCoordinatorCanFulfill(
                msg.sender,
                vrfInfo.vrfCoordinatorAddress
            );
        }
        console.log("calling fulfillRandomWords", requestId, randomWords[0]);
    ...
    function setVrfInfo(VrfInfoStructPrm calldata _vrfInfo) public {
        ...
        console.log(
            "VRFCoordinatorV2Interface(vrfInfo.vrfCoordinatorAddress)",
            vrfInfo.vrfCoordinatorAddress
        );
    ...
    //     bytes32 keyHash /*VRFConsumerBaseV2(vrfCoordinator)*/
    // ) {
    ...
    function requestRandomWords() external {
        ...
        s_requestId = vrfInfo.COORDINATOR.requestRandomWords(
            vrfInfo.keyHash,
